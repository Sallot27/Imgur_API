...
function requestAlbum() {
    ...
    document.getElementById('fetchWithPromises').addEventListener('click', fetchWithPromises);
    document.getElementById('fetchWithAsyncAwait').addEventListener('click', fetchWithAsyncAwait);
